  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl p-6 md:p-8 text-white mb-8"
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-3xl font-bold">{earnedBadges.length} / {allBadges.length}</p>
